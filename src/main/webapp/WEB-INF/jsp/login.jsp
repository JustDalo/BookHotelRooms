    ...
    <div id="mainContent">
        ...
        <c:choose>
            <c:when test="${not empty requestScope.error}">
                ...
                <a href="${pageContext.request.contextPath}/controller?command=show-login"> <fmt:message
                        key="tryAgain"/> </a>
            </c:when>
            <c:otherwise>
                <form class="entryForm" action="${pageContext.request.contextPath}/controller?command=login"
                      method="post">
