...
<fmt:bundle basename="pagecontent" prefix="myBooks.">
    ...
    <div id="mainContent">
        <h2 style="margin: 20px;"><fmt:message key="myBooks"/></h2>
        <c:if test="${not empty requestScope.books}">
            <div style="margin: 20px; border: #6c7279 ">
                <fmt:bundle basename="pagecontent" prefix="book.">
                    <c:forEach var="book" items="${requestScope.books}">
                        <br>
                        <p> <a href="${pageContext.request.contextPath}/controller?command=show-room&id=${book.roomId}">Room ${book.roomId} </a></p>
